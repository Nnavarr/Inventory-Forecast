...
regression_orig <- regression_orig[, c('Date', 'Units', 'Part_Number')]

regression_forecast <- 
  regression_list[['Forecast']]

regression_forecast <- regression_forecast[, c('Date', 'Part_Number', 'Forecast', 'Upper_Conf', 'Lower_Conf')]

# Combine into single data frame ----
combined_df <- bind_rows(regression_orig, regression_forecast)
